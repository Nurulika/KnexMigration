// src/lib.rs
/*
 * Core library for KnexMigration
 */
...
#[derive(Debug)]
pub struct KnexMigrationProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KnexMigrationProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KnexMigration processing");
    
    let mut processor = KnexMigrationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KnexMigrationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KnexMigrationProcessor::new(false);
